(function() {
	...
	tinymce.create('tinymce.plugins.InsertInPageGallery', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceInsertInPageGallery', function() {
				ed.windowManager.open({
					file : url + '/inpagegallery.html?1',
					width : 320 + parseInt(ed.getLang('inpagegallery.delta_width', 0)),
					height : 150 + parseInt(ed.getLang('inpagegallery.delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url,
